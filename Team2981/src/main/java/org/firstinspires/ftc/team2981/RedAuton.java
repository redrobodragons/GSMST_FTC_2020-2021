...
//Keep running until you are about two rotations out
    ...
    public void grip(double rightGripAngle, double leftGripAngle, int timer){
        rightGrip.setPosition(rightGripAngle);
        sleep(timer);
        //leftGrip.setPosition(leftGripAngle);
    }
    ...
    public void runOpMode() throws InterruptedException{
        ...
        waitForStart();
        strafeRight(.6, .6, 20, 18, 2, 750);
        forward(.6,.6,49.5,20,1,1000);
        grip(0,0,1000); //Down?
        backward(-.6,-.6,55,20,1,1000);
        grip(180,0,1000); //Up
        strafeLeft(.6,.6,50, 20, 2, 500);
        forward(.6,.6,26.5,20,1,1000);
        dropRollers();
        strafeLeft(.6,.6,35, 20, 2, 500);
